...
// std::mt19937 gen(rd());
// std::uniform_real_distribution<> dis(2, 5);//uniform distribution between 0 and 1

const std::string NAME = "coinrun2";
...
class CoinRun2 : public BasicAbstractGame {
  public:
    ...
    void generate_coin_to_the_right() {
        ...
        set_obj(curr_x - jitter_x , curr_y + jitter_y, GOAL);
